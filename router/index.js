...
exports.init = function (app) {
  ...
  app.post("/check_obj_unit", passport.authenticate('jwt', { session: false }), objectivesController.checkObjectiveUnit);
  app.put("/drag_objectives", passport.authenticate('jwt', { session: false }), objectivesController.dragObjective);
  ...
  app.post("/check_packingType", passport.authenticate('jwt', { session: false }), packingTypesController.checkPackingType);
  ...
  app.put('/drag_analysisTypes', passport.authenticate('jwt', { session: false }), analysisTypesController.dragAnalysisType);
  ...
  app.post("/check_unit", passport.authenticate('jwt', { session: false }), unitsController.checkUnit);
